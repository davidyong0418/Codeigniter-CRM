        ...
        if (isset($menu['parents'][$parent])) {
            ...
            foreach ($menu['parents'][$parent] as $itemId) {
                ...
                if (!isset($menu['parents'][$itemId])) { //if condition is false only view menu
                    $html .= "<li class='" . $active . "' >\n  <a class='waves-effect waves-dark' $terget title='" . lang($menu['items'][$itemId]->label) . "' href='" . base_url() . $menu['items'][$itemId]->link . "'>\n <em class='" . $menu['items'][$itemId]->icon . "'></em><span class='hide-menu'>" . lang($menu['items'][$itemId]->label) . "</span></a>\n</li> \n";
                }
                if (isset($menu['parents'][$itemId])) { //if condition is true show with submenu
                    $html .= "<li class='" . $active . "'>\n  <a class='has-arrow waves-effect' data-toggle='collapse' href='javascript:void(0)'> <em class='" . $menu['items'][$itemId]->icon . "'></em><span class='hide-menu'>" . lang($menu['items'][$itemId]->label) . "</span></a>\n";
