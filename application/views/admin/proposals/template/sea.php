...
<div class="sea card">
        <div class="card-header">    <h3>SEARCH ENGINE ADVERTISING (SEA)</h3></div>
        <?php 
            $subcontent = $this->db->where('template','sea')->get('tbl_proposal_template')->result();
            print_r($subcontent[0]->content);
        ?>
</div>
<script>
    var table = `<div class="card-body sea-table-content">
            <div class="sea-table">
        ...
        $('.sea .proposal-content').html(table);
