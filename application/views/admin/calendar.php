...
<div class="dashboard row ">
    ...
    <div class="full-calender">
        ...
        <div class="col-sm-12 mt-lg">
            <div class="panel panel-custom card-body">
                                ...
                                <?php if ($this->session->userdata('user_type') == 1) { ?>
                                    <div class="pull-right ml">
                                        <a data-toggle="modal" data-target="#myModal" 
                                           ...
                                           class="text-default ml btn waves-effect waves-light btn-xs" style="padding-right: 15px;    border-color: #dee2e6;
    background-color: #f8f9fa;"><i class="fa fa-cogs"></i></a>
                                    </div>
                                <?php } ?>
                                <div class="pull-left">
                                    <div class="btn-group ">
                                        <button class="btn waves-effect waves-light btn-xs btn-success dropdown-toggle" data-toggle="dropdown">
                                            <?php
                                            if (!empty($searchType)) {
