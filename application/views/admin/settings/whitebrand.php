...
// var_dump($created);
    ...
    <ul class="nav nav-tabs">
        ...
        <div class="tab-content bg-white">
            <!-- ************** general *************-->
            <?php if ( $action == ''){?>
        <a href="<?= base_url() ?>admin/settings/whitebrandkeyword/new" class="btn btn-success float-right"><i class="fas fa-plus"></i>Add New Brand</a> 
                    ...
                    <table class="table table-striped DataTables " id="DataTables" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i;$i++;?></td>
                                <td>
                                <?php echo $item['white_brand']; ?>
                                </td>
                                <td>
                                    <?php echo btn_edit('admin/settings/whitebrand/edit/' . $item['id']); ?>
                                    <?php echo btn_view('admin/settings/whitebrand/view/' . $item['id']); ?>
                                    <?php echo btn_delete('admin/settings/whitebrand/delete/' . $item['id']); ?>
                                </td>
                            </tr>
                            <?php 
                                    }
             ...
             <form role="form" data-parsley-validate="" novalidate="" id="userform"
                            ...
                            action="<?php echo base_url(); ?>admin/settings/save_whitebrand/<?php if(!empty($id)){echo $id;}?>" method="post"
            ...
            <?php if ($action != ''){?>
                ...
                <div class="tab-pane active" id="industry_cm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <a href="<?= base_url() ?>admin/settings/whitebrand" class='btn btn-primary'>Back</a> 
                            <?php if ($action != 'view'){ ?>
                                <input type="button" class="btn btn-primary add-new-keyword" onClick="" value="New Brand">
