                    ...
                    <div class="form-group">
                            ...
                            <select name="default_status" class="form-control">
                                ...
                                if (!empty($status_info)) {
                                    foreach ($status_info as $v_status) {
                                        ?>
                                        <option
                                            value="<?= $v_status->status ?>"<?= (config_item('default_status') == $v_status->status ? ' selected="selected"' : '') ?>><?= $v_status->status ?></option>
                                        <?php
                                    }
                                }
                                ?>
                        ...
                        <div class="col-lg-2">
                            <a data-toggle="modal" data-target="#myModal"
                               href="<?= base_url() ?>admin/settings/manage_status/status"
