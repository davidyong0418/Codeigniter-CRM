    ...
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
            <li class="<?= $active == 1 ? 'active' : ''; ?>">
                <a href="<?php echo base_url(); ?>admin/settings/industry_roi">
                    <?= lang('industry_views') ?></a></li>
            <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="<?php echo base_url(); ?>admin/settings/industry_roi/new"
                                                                ><?= lang('new_industry') ?></a>
            </li>
        </ul>
        <div class="tab-content bg-white">
                                ...
                                if (!empty($pricing_data)) {
                                    foreach ($pricing_data as $pricing_item) {
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td>
                                                <?php echo btn_edit('admin/settings/industry_roi/' . $pricing_item->id); ?>
                                            </td>
                                        </tr>
                                        <?php
                                    }
            ...
            <div class="tab-pane <?= empty($new)? 'active' : ''; ?>" id="new">
                <form role="form" data-parsley-validate="" novalidate="" id="userform"
                      ...
                      action="<?php echo base_url(); ?>admin/settings/save_industryroi/<?php echo $edit_id;?>" method="post"
                    ...
                    <div class="form-group mt">
                        ...
                        <div class="tab-pane <?= !empty($new)? 'active' : ''; ?>" id="new">
                            <form role="form" data-parsley-validate="" novalidate="" id="userform"
                                enctype="multipart/form-data"
                                action="<?php echo base_url(); ?>admin/settings/save_industryroi/new" method="post"
                                class="form-horizontal form-groups-bordered">
