                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if (!empty($currently_clock_in)) {
                                                    echo $currently_clock_in . ' ' . '<a style="padding:5px 10px; font-size: 12px;" class="label label-danger" href="' . base_url() . 'admin/dashboard/set_clocking/' . $clock_id . '/' . $users[$nkey]->user_id . '"' . '>' . lang('clock_out') . '</a>';
                                                } else {
                                                    echo $holiday . ' ' . '<a style="padding:5px 10px; font-size: 12px;" class="label label-success" href="' . base_url() . 'admin/dashboard/set_clocking/0/' . $users[$nkey]->user_id . '/1"' . '>' . lang('clock_in') . '</a>';
                                                }
                                                ?>
                                            </td>
                                        </tr>
