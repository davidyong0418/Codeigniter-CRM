    ...
    <form role="form" id="from_items" action="<?php echo base_url(); ?>admin/calendar/save_settings"
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('project_color') ?>" name="project_color" class="form-control"/>
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('milestone_color') ?>" name="milestone_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('tasks_color') ?>" name="tasks_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('bugs_color') ?>" name="bugs_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('invoice_color') ?>" name="invoice_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('payments_color') ?>" name="payments_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('estimate_color') ?>" name="estimate_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('opportunities_color') ?>" name="opportunities_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('goal_tracking_color') ?>" name="goal_tracking_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('absent_color') ?>" name="absent_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="hidden" value="<?= config_item('on_leave_color') ?>" name="on_leave_color" class="form-control"/>
                        <span class="input-group-addon"><i></i></span>
                    </div>
                </div>
            </div>
