                            ...
                            <div class="row">
                                <div class="col-md-3 br">
                                    ...
                                    <form class="form-horizontal p-20">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('client') ?> :</strong></div>
                                            <div class="col-sm-7">
                                                <strong><?php echo $name; ?></strong>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('start_date') ?> :</strong></div>
                                            <div class="col-sm-7">
                                        ...
                                        ?>
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('end_date') ?> :</strong></div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('demo_url') ?> :</strong></div>
                                            <div class="col-sm-7">
                                                <strong><?php
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('status') ?>
                                                    :</strong></div>
                                            <div class="col-sm-7">
                                                <?php
                                ...
                                <div class="col-md-3 br">
                                    ...
                                    <form class="form-horizontal p-20">
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('timer_status') ?>:</strong></div>
                                            <div class="col-sm-7">
                                                <?php if ($project_details->timer_status == 'on') { ?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('billing_type') ?> :</strong></div>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('project_cost') ?> :</strong></div>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-5"><strong><?= lang('participants') ?>
                                                    :</strong></div>
                                            <div class="col-sm-7">
                                                <div class="col-sm-7">
                                                    <?php
                                            ...
                                            foreach ($show_custom_fields as $c_label => $v_fields) {
                                                if (!empty($v_fields)) {
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-5"><strong><?= $c_label ?> :</strong></div>
                                                        <div class="col-sm-7">
                                                            <?= $v_fields ?>
                                                        </div>
                                                    </div>
