...
<link href="<?php echo base_url(); ?>dist/css/pages/tab-page.css" rel="stylesheet">
<?php
$mdate = date('Y-m-d');
...
if ($this->session->userdata('user_type') == 1) {
    ...
    ?>
    <div class="row card-body" style="<?= $margin ?>">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="row row-table ">
                ...
                ?>
                <div class="col-6 text-center pt" data-toggle="tooltip" data-placement="top"
...
<div class="row card-body">
    <div class="col-sm-12">
        <div class="nav-tabs-custom row">
            <!-- Tabs within a box -->
            <ul class="nav nav-tabs customtab col-6">
                <li class="nav-item <?= $active == 1 ? 'active' : '' ?>">
                <a href="#manage" class="nav-link"
                                                                    data-toggle="tab"><?= lang('all') . ' ' . lang($tab) ?></a>
                </li>

                <li class="<?= $active == 2 ? 'active' : ''; ?> nav-item"><a href="#create" class="nav-link" 
                                                                    data-toggle="tab"><?= lang('new_project') ?></a>
                </li>
                <li class="nav-item"><a style="background-color: #1797be;color: #ffffff" class="nav-link" 
            ...
            <ul class="nav nav-tabs col-6">
                <li class="pull-right <?= $active == 'completed' ? 'active' : ''; ?> nav-item"><a class="nav-link" 
                ...
                <li class="pull-right <?= $active == 'cancel' ? 'active' : ''; ?> nav-item"><a class="nav-link" 
                ...
                <li class="pull-right <?= $active == 'in_progress' ? 'active' : ''; ?>"><a class="nav-link" 
                ...
                <li class="pull-right <?= $active == 'on_hold' ? 'active' : ''; ?>"><a class="nav-link" 
                ...
                <li class="pull-right <?= $active == 'started' ? 'active' : ''; ?>"><a class="nav-link" 
                ...
                <li class="pull-right <?= $active == 'overdue' ? 'active' : ''; ?>"><a class="nav-link" 
            ...
            <div class="tab-content bg-white col-12">
                <!-- ************** general *************-->
                <div
                    ...
                    <?php if (!empty($created) || !empty($edited)){
                        ...
                        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                            <?php echo form_open(base_url('admin/projects/saved_project/' . $projects_id), array('class' => '', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
                            <div class="panel-body row padding-top-10">
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('project_name') ?> <span
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('select_client') ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="col-lg-12 control-label"><?php echo lang('progress'); ?> </label>
                                        <div class="col-lg-8">
                                ...
                                <span class="input-group-addon btn btn-default">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('start_date') ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('end_date') ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('billing_type') ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                    ...
                                    ?>>
                                        <label class="col-lg-12 control-label"><?= lang('fixed_price') ?></label>
                                        <div class="col-lg-8">
                                    ...
                                    ?>>
                                        <label
                                            class="col-lg-12 control-label"><?= lang('project_hourly_rate') ?></label>
                                        <div class="col-lg-8">
                                            <input data-parsley-type="number" type="text"
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('estimate_hours') ?></label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('status') ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('demo_url') ?></label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="form-group" id="border-none">
                                        <label for="field-1"
                                               class="col-lg-12 control-label"><?= lang('assined_to') ?> <span
                                    ...
                                    ?>" id="permission_user_1">
                                        <label for="field-1"
                                               class="col-lg-12 control-label"><?= lang('select') . ' ' . lang('users') ?>
                                            <span
                                                class="required">*</span></label>
                                        <div class="col-lg-8">
                                            <?php
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="col-lg-12 control-label"><?= lang('description') ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-12">
                            
                            <textarea style="" name="description" class="form-control col-12 textarea_"
                                ...
                                ?></textarea>
                                    ...
                                    <div class="form-group mt-lg project-update-button">
