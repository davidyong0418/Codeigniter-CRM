                                    ...
                                    foreach ($total_timer as $v_tasks) {
                                        ...
                                        if (!empty($task_info)) {
                                            ...
                                            <tr id="table_tasks_timer-<?= $v_tasks->tasks_timer_id ?>">
                                                ...
                                                <td><span
                                                        class="label label-success"><?=  strftime(config_item('date_format'), $v_tasks->start_time) . ' ' . display_time($v_tasks->start_time) ?></span>
                                                </td>
                                                <td><span
                                                        class="label label-danger"><?= strftime(config_item('date_format'), $v_tasks->end_time) . ' ' . display_time($v_tasks->end_time) ?></span>
                                                </td>
