    ...
    <div class="col-sm-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                <li class="<?= $active == 1 ? 'active' : '' ?>"><a href="<?= base_url()?>/admin/contact/manage_client"
                                                                   >Contact list</a></li>
                <li class="<?= $active == 2 ? 'active' : '' ?>"><a href="<?= base_url()?>/admin/contact/manage_client/new"
                                                                 >New Contact</a></li>
                                            ...
                                            <div class="chart tab-pane active" id="general">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <select class="form-control" name="contact_type">
                                                            <option value="1" <?php
                                                               if (!empty($client_info->contact_type) && $client_info->contact_type == 1) {
                                                                   echo 'selected';
                                                               }
                                                               ?>>Lead</option>
                                                            
                                                            <option value="2" <?php
                                                               if (!empty($client_info->contact_type) && $client_info->contact_type == 2) {
                                                                   echo 'selected';
                                                               }
                                                               ?>>Client</option>
                                                            <option value="3" <?php
                                                            if (!empty($client_info->contact_type) && $client_info->contact_type == 3) {
                                                                echo 'selected';
                                                            }
                                                            ?>>Contact</option>
                                                            <option value="4" <?php
                                                               if (!empty($client_info->contact_type) && $client_info->contact_type == 4) {
                                                                   echo 'selected';
                                                               }
                                                               ?>>Ex-Client</option>
                                                            <option value="5" <?php
                                                               if (!empty($client_info->contact_type) && $client_info->contact_type == 5) {
                                                                   echo 'selected';
                                                               }
                                                               ?>>Reffral Partner</option>
                                                            <option value="6" <?php
                                                               if (!empty($client_info->contact_type) && $client_info->contact_type == 6) {
                                                                   echo 'selected';
                                                               }
                                                               ?>>Scope</option>
                                                        </select>
                                                         ...
                                                         <select class="form-control margin-l-5" name="additional_email_label[]">
                                                            ...
                                                            <?php if($j == 0){?>
                                                                <div class="input-group-addon">
                                                                    <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/contact/add_additional_label_modal" class="add-additional-label-modal"><i class="fa fa-pencil"></i></a>
                                                                </div>
                                                                <div class="input-group-addon">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="industries[]" id="optional" multiple="multiple" data-placeholder="Select Industry..." class="form-control" required="">
                                                        <?php if(!empty($industries)){
                                                            ...
                                                            {
                                                        ?>    
                                                            <option value="<?php echo $industry->id; ?>" <?php if(!empty($client_info) && array_search($industry->id,$industry_array)){echo 'selected';}?>><?php echo $industry->industry ?></option>
                                                        <?php 
                                                            }
                                                            }
                                                            else{
                                                ...
                                                <div class="form-group additional_icon">
                                                    ...
                                                    <div class="col-lg-5 d-flex">
                                                        ...
                                                        <div class="input-group-addon">
                                                            <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/contact/add_company_modal" class="add-additional-label-modal"><i class="fa fa-plus"></i></a>
                                                ...
                                                <script>
                                                    $(document).ready(function(){
                                                        ...
                                                        $('#social-media-select').change(function(){
                                                            ...
                                                            $.post('<?= base_url()?>admin/contact/get_company_social_links',data).done(function(data){
                                                                console.log(data);
                                                    ...
                                                    <div class="col-lg-12 margin-t-5">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-addon">
                                                                        <a href="<?= base_url() ?>admin/contact/manage_client/new" class="add-additional-label-modal"><i class="fa fa-plus"></i></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12 margin-t-5">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-addon">
                                                                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/contact/add_cold_call_type_modal" class="add-additional-label-modal"><i class="fa fa-plus"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="text" class="form-control" required=""
                                                ...
                                                ?>" name="access_login_url" required>
                                        </div>
                                    </div>
