    ...
    <div class="col-sm-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                <li class="<?= $active == 1 ? 'active' : '' ?>"><a href="<?= base_url()?>/admin/client/manage_client"
                                                                   >Client list</a></li>
                <li class="<?= $active == 2 ? 'active' : '' ?>"><a href="<?= base_url()?>/admin/client/manage_client/new"
                                                                 >New Client</a></li>
                
                <li><a style="background-color: #03a9f3;color: #ffffff"
                       href="<?= base_url() ?>admin/client/import">Import Client</a>
                </li>
            </ul>
                                ...
                                if (!empty($all_client_info)) {
                                    ...
                                    foreach ($all_client_info as $client_details) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($edited)) { ?>
                                                    <?php echo btn_edit('admin/client/manage_client/' . $client_details->id) ?>
                                                <?php }
                                                if (!empty($deleted)) {
                                                    ?>
                                                    <?php echo btn_delete('admin/client/delete_client/' . $client_details->id) ?>
                                                <?php } ?>
                                                <?php echo btn_view('admin/client/contact_details/' . $client_details->id) ?>
                                            </td>
                                        </tr>
                                        <?php
                                    }
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="tab-content bg-white">
                                            ...
                                            <div class="chart tab-pane active" id="general">
                                                ...
                                                <input type="hidden" class="form-control" name="contact_type" value="3">
                                                         ...
                                                         <select class="form-control margin-l-5" name="additional_email_label[]">
                                                            ...
                                                            <?php if($j == 0){?>
                                                                <div class="input-group-addon">
                                                                    <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/client/add_additional_label_modal" class="add-additional-label-modal"><i class="fa fa-pencil"></i></a>
                                                                </div>
                                                                <div class="input-group-addon">
                                                ...
                                                <?php }
                                                    ...
                                                    <div class="form-group website-url additional_icon">
                                                        ...
                                                        <div class="col-lg-5 d-flex">
                                                            <input type="url" class="form-control" value="" name="website_url[]" required>
                                                            <input type="text" name="website_url_label[]" class="form-control margin-l-5" value="" required>
                                                            <div class="input-group-addon"> 
                                                                    <a class="website-add-more"><i class="fa fa-plus"></i></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group additional_icon">
                                                    ...
                                                    <div class="col-lg-5 d-flex">
                                                        ...
                                                        <div class="input-group-addon">
                                                            <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/client/add_company_modal" class="add-additional-label-modal"><i class="fa fa-plus"></i></a>
                                                ...
                                                <script>
                                                    $(document).ready(function(){
                                                        ...
                                                        $('#social-media-select').change(function(){
                                                            ...
                                                            $.post('<?= base_url()?>admin/client/get_company_social_links',data).done(function(data){
                                                                console.log(data);
                              ...
                              ?>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <select name="interest_level" class="form-control select_box" style="width: 100%">
                                                    ...
                                                    <div class="col-lg-12 margin-t-5">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-addon">
                                                                        <a href="<?= base_url() ?>admin/client/manage_client/new" class="add-additional-label-modal"><i class="fa fa-plus"></i></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12 margin-t-5">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-addon">
                                                                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/client/add_cold_call_type_modal" class="add-additional-label-modal"><i class="fa fa-plus"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            if(empty($client_info->sales_rep_check)){echo 'display-none';}?>">
                                                ...
                                                if(empty($client_info->request_proposal)){echo 'display-none';}?>">
                                                    ...
                                                    <div class="col-lg-12 margin-t-5">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="input-group">
                                                                <select name="price_category" class="form-control select_box" style="width: 100%" required>
                                        ...
                                        <div>
                                            <div class="col-lg-5">
                                                <div class="col-lg-12 margin-t-5 nopaddingright">
                                                    <label class="col-lg-4 control-label">Username</label>
                                                    <div class="col-lg-8 nopaddingright">
                                                        <input type="text" class="form-control"  value="" name="access_username[]">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 margin-t-5 nopaddingright">
                                                    <label class="col-lg-4 control-label">Associated Email Address</label>
                                                    <div class="col-lg-8 nopaddingright">
                                                        <input type="text" class="form-control" value="" name="access_email_address[]">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 margin-t-5 nopaddingright">
                                                    <label class="col-lg-4 control-label">Password</label>
                                                    <div class="col-lg-8 nopaddingright">
                                                        <input type="text" class="form-control" value="" name="access_password[]">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 margin-t-5 nopaddingright">
                                                    <label class="col-lg-4 control-label">Who can view this</label>
                                                    <div class="col-lg-8 nopaddingright">
                                                        <input type="text" class="form-control" value="" name="access_view[]">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
