        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
            <form method="post" data-parsley-validate="" novalidate=""
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <div class=" ">
                            <select class="form-control select_box" style="width:100%" required name="project_id">
                                <?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <div class=" ">
                            <select name="departments_id" required class="form-control select_box" style="width: 100%">
                                <?php
